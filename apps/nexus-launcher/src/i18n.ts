...
const english: Record<string, string> = {
  ...
  "Node and pnpm are required. Nexus prefers your own tools, then the ones shipped with Nexus; each version's exact requirements are checked against them.": "Node and pnpm are required. Nexus prefers your own tools, then the ones shipped with Nexus; each version's exact requirements are checked against them.",
  "Bundled": "Bundled",
  ...
  "Nexus uses your own tools first, then the ones bundled with it. You can pin exact paths in Runtime settings above.": "Nexus uses your own tools first, then the ones bundled with it. You can pin exact paths in Runtime settings above.",
  "Disabled": "Disabled",
  ...
  "Manual paths are saved as system pins. Leave blank to resolve automatically: your system tools first, then the ones bundled with Nexus.": "Manual paths are saved as system pins. Leave blank to resolve automatically: your system tools first, then the ones bundled with Nexus.",
...
const chinese: Record<string, string> = {
  ...
  "Node and pnpm are required. Nexus prefers your own tools, then the ones shipped with Nexus; each version's exact requirements are checked against them.": "Node 与 pnpm 必需。Nexus 优先使用你自己的工具，其次使用随 Nexus 附带的内置工具；每个版本的精确要求都会与它们核对。",
  "Bundled": "内置",
  ...
  "Nexus uses your own tools first, then the ones bundled with it. You can pin exact paths in Runtime settings above.": "Nexus 优先使用你自己的工具，其次使用内置工具；也可以在上方运行时设置里手动指定路径。",
  "Disabled": "已关闭",
  ...
  "Manual paths are saved as system pins. Leave blank to resolve automatically: your system tools first, then the ones bundled with Nexus.": "手动路径会保存为 system pin。留空则自动解析：优先系统工具，其次 Nexus 内置工具。",
